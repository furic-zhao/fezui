    ...
    <div :class="classes">
        <div :class="[prefixCls + '-body']">
            ...
            <div :class="[prefixCls + '-content', prefixCls + '-content-right']">
                ...
                <time-spinner ref="timeSpinnerEnd" :show-seconds="showSeconds" :hours="hoursEnd" :minutes="minutesEnd" :seconds="secondsEnd" :disabled-hours="disabledHours" :disabled-minutes="disabledMinutes" :disabled-seconds="disabledSeconds" :hide-disabled-options="hideDisabledOptions" @on-change="handleEndChange" @on-pick-click="handlePickClick"></time-spinner>
            </div>
...
const timePrefixCls = 'fez-time-picker';
