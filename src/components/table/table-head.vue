                    ...
                    <div :class="cellClasses(column)">
                        ...
                        <template v-else>
                            ...
                            <span :class="[prefixCls + '-sort']" v-if="column.sortable">
                                <i class="fez-icon fez-icon-arrow-up-b" :class="{on: column._sortType === 'asc'}" @click="handleSort(index, 'asc')"></i>
                                <i class="fez-icon fez-icon-arrow-down-b" :class="{on: column._sortType === 'desc'}" @click="handleSort(index, 'desc')"></i>
                            </span>
                            <Poptip v-if="isPopperShow(column)" v-model="column._filterVisible" placement="bottom" @on-popper-hide="handleFilterHide(index)">
                                <span :class="[prefixCls + '-filter']">
                                    <i class="fez-icon fez-icon-funnel" :class="{on: column._isFiltered}"></i>
                                </span>
