<template>
    <ul :class="simpleWrapClasses" :style="styles" v-if="simple">
        <li :title="t('i.page.prev')" :class="prevClasses" @click="prev">
            <a><i class="fez-icon fez-icon-ios-arrow-left"></i></a>
        </li>
        ...
        <li :title="t('i.page.next')" :class="nextClasses" @click="next">
            <a><i class="fez-icon fez-icon-ios-arrow-right"></i></a>
        </li>
    </ul>
    <ul :class="wrapClasses" :style="styles" v-else>
        ...
        <li :title="t('i.page.prev5')" v-if="currentPage - 3 > 1" :class="[prefixCls + '-item-jump-prev']" @click="fastPrev"><a><i class="fez-icon fez-icon-ios-arrow-left"></i></a></li>
        ...
        <li :title="t('i.page.next5')" v-if="currentPage + 3 < allPages" :class="[prefixCls + '-item-jump-next']" @click="fastNext"><a><i class="fez-icon fez-icon-ios-arrow-right"></i></a></li>
        <li :title="allPages" v-if="allPages > 1" :class="lastPageClasses" @click="changePage(allPages)"><a>{{ allPages }}</a></li>
        <li :title="t('i.page.next')" :class="nextClasses" @click="next">
            <a><i class="fez-icon fez-icon-ios-arrow-right"></i></a>
        </li>
        <Options :show-sizer="showSizer" :page-size="currentPageSize" :page-size-opts="pageSizeOpts" :show-elevator="showElevator" :_current.once="currentPage" :current="currentPage" :all-pages="allPages" :is-small="isSmall" @on-size="onSize" @on-page="onPage">
        </Options>
    </ul>
</template>
<script>
